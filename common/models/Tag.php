...
class Tag extends BaseAR
{
	...
	public function rules()
	{
		...
		return array(
			array('gid, position', 'required'),
			array('gid, position, default', 'numerical', 'integerOnly'=>true),
			array('tagname', 'length', 'max'=>64),
			array('c_time, m_time', 'length', 'max'=>10),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, gid, position, tagname, default, c_time, m_time', 'safe', 'on'=>'search'),
		);
	}
